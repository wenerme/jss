...
public class ColumnDefinition41 implements Packet
{
    ...
    public String toString()
    {
        return "ColumnDefinition41{" +
                "catalog=" + Stringer.string(catalog) +
                ", schema=" + Stringer.string(schema) +
                ", table=" + Stringer.string(table) +
                ", orgTable=" + Stringer.string(orgTable) +
                ", name=" + Stringer.string(name) +
                ", orgName=" + Stringer.string(orgName) +
                ", fixedLengthFieldsLength=" + fixedLengthFieldsLength +
                ", characterSet=" + Dumper.charset(characterSet) +
                ", columnLength=" + columnLength +
                ", type=" + Dumper.sqlType(type) +
                ", flags=" + flags +
                ", decimals=" + decimals +
                ", filler=" + filler +
                ", defaultValuesLength=" + defaultValuesLength +
